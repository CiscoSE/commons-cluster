...
public class ClusterControllerTest {
    ...
    public void clusterTest() {
        ...
        ServiceClusterController connectionLostTestClusterController = null;
        ...
        try (TestingServer zooKeeper = new TestingServer(true)) {
            ...
            ServiceClusterController leaderClusterController = null;
            ServiceClusterController followerClusterController = null;
            ...
            try {
                ...
                String appInstance0Path = "/" + ServiceClusterController.PATH_PREFIX + "/service_discovery/test-app/" + appInstance0;
                ...
                logAllNodesPaths(followerClusterController.getClient().getZookeeperClient().getZooKeeper(), "/" + ServiceClusterController.PATH_PREFIX + "/service_discovery");
    ...
    private ServiceClusterController newClusterController(ClusterEventListener eventListener, String port) {
        ServiceClusterController clusterController = Mockito.spy(ServiceClusterController.class);
    ...
    public void clusterControllerBuilderTest() {
		...
		ServiceClusterController clusterController = ServiceClusterController.builder().appId(appId).eventListener(eventListener)
