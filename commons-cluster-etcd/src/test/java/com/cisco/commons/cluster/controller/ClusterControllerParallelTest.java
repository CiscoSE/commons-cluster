...
public class ClusterControllerParallelTest {
    ...
    public void clusterTest() {
        ...
        List<ServiceClusterController> clusterControllers = new LinkedList<>();
        ...
        try (TestingServer zooKeeper = new TestingServer(true)) {
            ...
            try {
                ...
                final ServiceClusterController clusterController0 = newclusterController(null, port);
                ...
                final ServiceClusterController clusterController1 = newclusterController(null, port);
                ...
                for (ServiceClusterController clusterController : clusterControllers) {
